...
while true do
 ...
 if hitfloor == true then
  ...
  if cdown == true then
   if flow < flowmin xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed> 8 then
          if combatmusic.Volume ~= 0.5 then
       combatmusic.Volume = 0
       ambience.Volume = 0
